...
PART X: Nice Rendered images:
![](img/ball3.png)
![](img/basic2.png)
![](img/nobarycenter.png)
![](img/barycenter.png)
note: the last two images are comparison of barycenter vs non-barycenter. The last used barycenter, which greatly smooth the surface of the object.
